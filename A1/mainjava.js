let subject = ["Bernd das Brot", "Bill Clinton", "Das Nachbarsbaby", "Jumbo Schreiner",];
let predicate = ["hasst", "debattiert", "verachtet", "genießt"];
let object = ["das Heizkostengesetz", "den Tod", "Schüttelfrost", "die Schule"];
